...
[![Github All Releases](https://img.shields.io/github/downloads/kahing/goofys/total.svg)](https://zs3fs/releases/)
...
* On Linux, install via [pre-built binaries](https://zs3fs/releases/latest/download/goofys). You may also need to install fuse-utils first.
...
[bench.sh](https://zs3fs/blob/master/bench/bench.sh). [Raw data](https://zs3fs/blob/master/bench/)
...
See also: [cached benchmark result](https://zs3fs/blob/master/bench/cache/README.md) and [result on Azure](https://zs3fs/blob/master/bench/azure/README.md).
